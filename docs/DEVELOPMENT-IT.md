...
Versione inglese predefinita: [DEVELOPMENT.md](DEVELOPMENT.md).
...
La workflow GitHub Actions compila entrambi i target, esegue i test net48 tramite `dotnet test` e i medesimi 25 casi net40 tramite un runner eseguibile minimale. I test LabVIEW rimangono manuali: un'eventuale automazione richiede comunque una macchina o VM con la versione LabVIEW corretta installata e licenziata.
