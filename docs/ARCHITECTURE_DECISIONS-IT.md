...
Versione inglese predefinita: [ARCHITECTURE_DECISIONS.md](ARCHITECTURE_DECISIONS.md).

Nota successiva: il backend condiviso ora produce anche un target `net40`, verificato con gli stessi 25 test funzionali del target `net48`. Questa verifica non certifica i wrapper LabVIEW 2013, che richiedono ancora un ambiente LabVIEW 2013 dedicato per relinking, build, packaging e smoke test.
